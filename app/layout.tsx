...
export const metadata: Metadata = {
  title: 'Nemidas Chaudhari',
  description: 'Nemidas Chaudhari Portfolio',
}
            ...
            <header className='lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24'>
              <div className='mb-16'>
                ...
                <h2 className='mt-3 text-lg font-medium tracking-tight'>
                  <span className='mr-1'>Full Stack Developer | Seeking Full-Time Software Engineer Job | CSE'24</span>
                </h2>
