    ...
    const expreriences = [
        {
            ...
            description:
                "Collaborated on Salesforce CRM implementations, leveraging a comprehensive understanding of Customer Relationship Management principles and Salesforce’s capabilities as a leading CRM platform. Applied SDLC (Software Development Life Cycle) methodologies and project management essentials to ensure efficient development and deployment of Salesforce solutions.",
            skills: ["React.js", "HTML5", "SQL", "JavaScript", "Git"],
        },
    ];
